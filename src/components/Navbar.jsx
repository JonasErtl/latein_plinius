...
import { Bars3Icon, BellIcon, XMarkIcon, BookOpenIcon, BookmarkIcon } from '@heroicons/react/24/outline'
...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-gradient-to-r from-gray-800 to-gray-600 ...">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-2">
            <div className="relative flex h-16 items-center justify-between rounded">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden rounded">
                {/* Mobile menu button*/}
